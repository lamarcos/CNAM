...
public class Carte78 extends CarteDeBase implements ICarte
{
	
	
	public static final int NBR_CARTES = 78;	
	public static final String DOS = "[!!!!]";	
	private final TypeCarte typeCarte;
	private final Famille famille;
	
	public Carte78(TypeCarte typeCarteTmp, Famille familleTmp) {
